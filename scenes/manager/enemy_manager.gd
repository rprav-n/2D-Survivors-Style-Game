...
func get_spawn_position() -> Vector2:
	...
	for i in 4:
		...
		var query_paramerters: PhysicsRayQueryParameters2D = 	PhysicsRayQueryParameters2D.create(player.global_position, spawn_position + additional_check_offset, 1 << 0)
